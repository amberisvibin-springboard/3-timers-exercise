...
describe("Motorcycle Object Tests", function () {
  ...
  it("should inherit valid Vehicle methods", function () {
    ...
    expect(motorcycle.toString()).toBe(
...
describe("Garage Object Tests", function () {
  ...
  it("should have valid add() method", function () {
    ...
    expect(garage.add(new Car("Hyundai", "Elantra", 2015))).toBe(
      "Vehicle added!"
    );
    expect(garage.add(new Motorcycle("Honda", "Nighthawk", 2000))).toBe(
      "Sorry, we're full."
    );
  });
});
